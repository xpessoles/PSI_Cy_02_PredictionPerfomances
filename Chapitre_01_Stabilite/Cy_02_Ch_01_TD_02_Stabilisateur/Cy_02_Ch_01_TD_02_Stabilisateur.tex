% "{'classe':('PSI'),'chapitre':'slci_stabilite','type':('td'),'titre':'Stabilisateur actif d\\'image', 'source':'Mines Ponts 2018 - PSI','comp':(None),'corrige':False}"
...
\centering
\includegraphics[width=3cm]{Cy_02_Ch_01_TD_02_Stabilisateur_qr}
\end{marginfigure}
\fi