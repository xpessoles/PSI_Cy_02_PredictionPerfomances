% "{'classe':('PSI'),'chapitre':'slci_stabilite','type':('application'),'titre':'Stabilité des systèmes', 'source':'None ','comp':[],'corrige':True}"
...
\centering
\includegraphics[width=3cm]{Cy_02_Ch_01_Application_01_qr}
\end{marginfigure}
\fi
