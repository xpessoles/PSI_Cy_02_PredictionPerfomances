% "{'classe':('PSI','MP'),'chapitre':'slci_revisions','type':('td'),'titre':'Exosquelette lombaire', 'source':'Concours Centrale-Supélec 2023','comp':[],'corrige':True}"
...
\hline
\end{tabular}
\captionof{table}{Critères concepteur pour la boucle d'asservissement de la vitesse angulaire\label{Cy_02_Ch_04_TD_02_tab_04}}
\end{center}
...
\caption{Diagramme de Bode de $\indice{H}{BOv}(p)$}
 \label{Cy_02_Ch_04_TD_02_fig_13}
\end{figure}
\fi
...
\end{figure}
\fi
\marginnote[.5cm]{Il y a vraissemblablement une erreur dans le sujet de base : sur la figure \ref{Cy_02_Ch_04_TD_02_fig_15}, $\varepsilon_f(p)$ devrait être en amont du bloc $C(p)$.}
...
%\hline
Id1.3 & Rapidité & Temps de réponse à 5\% pour une consigne en échelon de force de $\SI{40}{N}$ & 
$\indice{tr}{5 \%}<\SI{1}{s}$ \\
%\cline { 3 - 5 }
 &  & Vitesse maximale de montée de la force de traction & $100 \mathrm{~N} \cdot \mathrm{s}^{-1}$ \\
\hline
\end{tabular}
\captionof{table}{Extrait du cahier des charges fonctionnel de l'actionneur linéaire sur le banc d'essai} 
\label{Cy_02_Ch_04_TD_02_tab_05}
...
\caption{Diagramme de Bode de $H_{B O f}(p)$} 
 \label{Cy_02_Ch_04_TD_02_fig_16}
\end{figure}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_02_Ch_04_TD_02_qr}
\end{marginfigure}
\fi
