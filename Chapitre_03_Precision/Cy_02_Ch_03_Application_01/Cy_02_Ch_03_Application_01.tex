% "{'classe':('PSI'),'chapitre':'slci_precision','type':('application'),'titre':'Précision des systèmes', 'source':'','comp':(None),'corrige':True}"
...
%\centering
%\includegraphics[width=3cm]{Cy_02_Ch_03_Application_01_qr}
%\end{marginfigure}
%\fi
%
%
