% "{'classe':('PSI'),'chapitre':'slci_stabilite','type':('colle'),'titre':'Performances', 'source':'Équipe PT La Martinière Monplaisir','comp':[],'corrige':False}"
...
\question{Déterminer l'erreur de statique et l'erreur de trainage.}
...
\centering
\includegraphics[width=3cm]{Cy_02_Ch_01_Colle_01_qr}
\end{marginfigure}
\fi
