...
\end{figure}
\fi
\marginnote{Il y a vraissemblablement une erreur dans le sujet de base : sur la figure \ref{Cy_02_Ch_04_TD_02_fig_15}, $\varepsilon_f(p)$ devrait être en amon du bloc $C(p)$.}
