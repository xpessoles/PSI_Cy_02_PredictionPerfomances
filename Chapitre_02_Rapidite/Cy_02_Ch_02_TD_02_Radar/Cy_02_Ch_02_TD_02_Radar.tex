% "{'classe':('PSI'),'chapitre':'slci_rapidite','type':('td'),'titre':'Radar d\\'avion', 'source':'F. Mathurin','comp':[],'corrige':False}"
%\setchapterimage{fig_00_bis}
\chapter*{TD \arabic{cptTD} \\ 
Radar d'avion -- \ifprof Corrigé \else Sujet \fi}

\addcontentsline{toc}{section}{TD \arabic{cptTD} : Radar d'avion -- \ifprof Corrigé \else Sujet \fi}
...
\centering
\includegraphics[width=3cm]{Cy_02_Ch_02_TD_02_qr}
\end{marginfigure}
\fi
