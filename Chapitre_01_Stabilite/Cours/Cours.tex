...
\begin{defi}[Définitions intuitives]
...
\item sa réponse \textbf{impulsionnelle} tend vers zéro au cours du temps.
\end{itemize}


On entend aussi parle de système \textbf{EBSB}, c'est-à-dire entrée bornée -- sortie bornée.
\end{defi}
...
\begin{resultat}
Condition (non suffisante ...) de stabilité : les pôles de la FTBO doivent être à partie réelle négative.
\end{resultat}
